...
function SidebarContent({ doctor, onLogout, onDeleteAccount, isDeletingAccount }: SidebarContentProps) {
  return (
            ...
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                ...
                <ul className="list-disc list-inside mt-2 space-y-1">
                  ...
                  <li>All patient consent records</li>
...
export default function DoctorDashboard() {
  ...
  const deleteAccountMutation = useMutation({
    mutationFn: async () => {
      return apiRequest("DELETE", `/api/doctors/${user?.id}`);
    },
    onSuccess: () => {
      toast({
    ...
    <div className="min-h-screen bg-background flex flex-col">
      <div className="flex flex-1">
        <aside className="hidden lg:flex w-64 border-r bg-sidebar flex-col">
          ...
          <SidebarContent doctor={doctor} onLogout={handleLogout} onDeleteAccount={() => deleteAccountMutation.mutate()} isDeletingAccount={deleteAccountMutation.isPending} />
        </aside>
